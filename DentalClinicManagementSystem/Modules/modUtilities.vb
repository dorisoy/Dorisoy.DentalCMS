...
Module modUtilities
    ...
    Public Sub Voucher_List_View(ByVal Sql As String, ByVal SharedParam As String)
        ...
        Try
            ...
            frmReportViewer.ReportViewer1.LocalReport.SetParameters(New ReportParameter() {
                                                                    rparam_clinic_name,
                                                                    rparam_clinic_address,
                                                                    rparam_clinic_phone,
                                                                    rparam_clinic_reportheader,
                                                                    rparam_clinic_reportfooter,
                                                                    rparam_clinic_logo, rparam_shared})
    ...
    Public Sub TreatmentBillList_View(ByVal Sql As String, ByVal SharedParam As String)
        ...
        Catch ex As Exception
            ...
            'Message = "未能加载文件或程序集“Microsoft.SqlServer.Types, Version=12.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91”或它的某一个依赖项。系统找不到指定的文件。"
            '未能加载文件或程序集“Microsoft.ReportViewer.ProcessingObjectModel, Version=12.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91”或它的某一个依赖项。系统找不到指定的文件。
            MsgBox("Error:" & ex.ToString)
        End Try
    End Sub
