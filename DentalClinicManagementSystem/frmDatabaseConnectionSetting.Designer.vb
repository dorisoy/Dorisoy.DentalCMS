...
Partial Class frmDatabaseConnectionSetting
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label2.Text = "连接字符串将应用程序连接到数据库"
        '
        'Label1
        '
        ...
        Me.txtConnectionString.Text = "Data Source=DESKTOP-N3DG9IC;Initial Catalog=dbDentalClinic;Persist Security Info=" &
    "True;User ID=sa;Password=racing.1;Encrypt=True;"
        '
        'GroupBox1
        '
